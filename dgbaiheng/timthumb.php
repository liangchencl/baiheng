...
*/
$_SERVER['DOCUMENT_ROOT'] = 'E:\home\LocalUser\646659\www';
...
if(! defined('FILE_CACHE_DIRECTORY') )          define ('FILE_CACHE_DIRECTORY', '../../imgcache');                             // Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
